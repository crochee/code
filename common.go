...
var (
	...
	ErrInternalServerError = Froze("CODE.5000000001", "服务器内部错误")
	ErrInvalidParam        = Froze("CODE.4000000002", "请求参数不正确")
	ErrNotFound            = Froze("CODE.4040000003", "资源不存在")
	ErrNotAllowMethod      = Froze("CODE.4050000004", "不允许此方法")
	ErrParseContent        = Froze("CODE.5000000005", "解析内容失败")
	ErrForbidden           = Froze("CODE.4030000006", "不允许访问")
	ErrUnauthorized        = Froze("CODE.4010000007", "用户未认证")
	ErrCodeUnknown         = Froze("CODE.5000000008", "未知错误")
)
